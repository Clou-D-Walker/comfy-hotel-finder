                                ...
                                <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
                                  <div>
                                    ...
                                    <p className="text-muted-foreground">
                                      {booking.roomId?.title || 'Room'} - Room {booking.roomNumber || 'N/A'}
                                    </p>
                                    <div className="flex items-center mt-2">
                                      <p className="text-sm">
                                        {new Date(booking.dateStart).toLocaleDateString()} - {new Date(booking.dateEnd).toLocaleDateString()}
                                      </p>
                                    </div>
                                  </div>
                                  
                                  <div className="flex flex-col space-y-2">
                                    <p className="font-semibold text-right">${booking.totalPrice}</p>
